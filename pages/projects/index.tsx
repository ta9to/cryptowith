                    ...
                    <div className="px-4 sm:px-6 lg:px-8">
                        <div className="sm:flex sm:items-center">
                            <div className="sm:flex-auto">
                                <h1 className="text-xl font-semibold text-gray-900">Cryptos</h1>
                                <p className="mt-2 text-sm text-gray-700">
                                    A list of all the cryptos.
                                </p>
                            </div>
                                            ...
                                            {allCryptos.map((crypto) => (
                                                <tr key={crypto.name}>
                                                    ...
                                                    <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                                        <div className="text-gray-900">{crypto.description}</div>
                                                    </td>
                                                    <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                                        <div className="text-gray-900"><a target={'_blank'} href={crypto.public_youtube_url}>{crypto.public_youtube_url}</a></div>
                                                    </td>
                        {/*                            <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">*/}
